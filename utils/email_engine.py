...
def _get_credentials():
    """Reads Gmail sender credentials from Streamlit secrets."""
    try:
...
def _send_email(to_email: str, subject: str, html_body: str) -> bool:
    """
    Sends a single HTML email. Returns True on success, False on
    any failure (and never raises — email failure should never
    break the app's core workflow).
    """
